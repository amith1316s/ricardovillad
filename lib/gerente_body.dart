...
class Gerente_body extends StatefulWidget {
  final BuildContext context;
  Gerente_body({this.context});

  @override
  Gerente_bodyState createState() => Gerente_bodyState();
}

class Gerente_bodyState extends State<Gerente_body> {
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
                            Row(
                  children: [
                    ApostaItem('Visualizer cambistas ativos', aposta2, () {
                      aposta1 = true;
                      aposta2 = false;
                      aposta3 = false;
                      aposta4 = false;
