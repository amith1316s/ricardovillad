...
class Banca_body extends StatefulWidget {
  final BuildContext context;
  Banca_body({this.context});

  @override
  Banca_bodyState createState() => Banca_bodyState();
}

class Banca_bodyState extends State<Banca_body> {
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Row(
                  children: [
                    ApostaItem('Quantidade de pontos pontos ativos', aposta1, () {
                      aposta1 = true;
                      aposta2 = false;
                      aposta3 = false;
                      aposta4 = false;
            ...
            SizedBox(height: 16),
                            Row(
                  children: [
                    ApostaItem('Visualizer gerentes e cambistas ativos', aposta2, () {
                      aposta1 = true;
                      aposta2 = false;
                      aposta3 = false;
                      aposta4 = false;
            ...
            SizedBox(height: 16),
                            Row(
                  children: [
                    ApostaItem('Volor total de jogos efetuados na semana', aposta2, () {
                      aposta1 = true;
                      aposta2 = false;
                      aposta3 = false;
                      aposta4 = false;
            ...
            SizedBox(height: 16),
             Row(
                  children: [
                    ApostaItem('Volor total de jogos efetuados no dia', aposta2, () {
                      aposta1 = true;
                      aposta2 = false;
                      aposta3 = false;
                      aposta4 = false;
            ...
            SizedBox(height: 16),
                            Row(
                  children: [
                    ApostaItem('Camissao a receber',  aposta2, () {
                      aposta1 = true;
                      aposta2 = false;
                      aposta3 = false;
                      aposta4 = false;
            ...
            SizedBox(height: 16),
              Row(
                  children: [
                    ApostaItem('Cadastrar novo GERENTE',  aposta2, () {
                      aposta1 = true;
                      aposta2 = false;
                      aposta3 = false;
                      aposta4 = false;
            ...
            SizedBox(height: 16),
              Row(
                  children: [
                    ApostaItem('Cadastrar novo CAMBISTA',  aposta2, () {
                      aposta1 = true;
                      aposta2 = false;
                      aposta3 = false;
                      aposta4 = false;
