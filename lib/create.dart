...
class CambistaCreateScreen extends StatefulWidget {
  @override
  CambistaCreateScreenState createState() => CambistaCreateScreenState();
}

class CambistaCreateScreenState extends State<CambistaCreateScreen> {
  String email;
  String username;
  String senha;
